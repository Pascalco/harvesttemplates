...
class Form extends React.Component {
  ...
  componentDidMount() {
    ...
    if (Object.keys(params).length > 0) {
      if ("htid" in params) {
        ...
        axios
          .get("https://pltools.toolforge.org/harvesttemplates/gethtshare.php", {
            params,
          })
          .then(response => {
  ...
  prepareHarvester() {
    ...
    ReactDOM.render(<Harvester candidates={fcandidates} job={this.job} />, document.getElementById("harvester"));
  ...
  loadItemsWithProperty() {
    ...
    axios
      ...
      .then(response => {
        this.itemswithproperty = response.data.results.bindings.map(x => ({
          ...
          if ("redirects" in pa) {
            for (let val of pa.redirects) {
              ...
              if (this.state.templateredirects_temp) {
                templateredirects[val.pageid] = {
                  title: val.title,
                  value: this.state.templateredirects_temp.includes(val.title),
                  pageid: val.pageid,
                };
              } else {
  ...
  handleSubmit(event) {
    ...
    if (this.state.parameters[0] === "" && this.state.aparameter1 === "") {
      ...
      ReactDOM.render(<div />, document.getElementById("harvester"));
      setTimeout(() => {
        this.markReady("buttonPressed");
      }, 1000);
    }
    ...
    for (let i = 0; i < this.state.parameters.length; i += 1) {
      standardfield.push(
        <input
          ...
          className={this.state.errors.includes("parameters") ? "inputerror" : ""}
        />
      );
    }
    let mainfield = (
        ...
        parameterfields = (
          <div>
            ...
            <input
              ...
              onFocus={this.handleFocus}
            />
            try to match target page even without wikisyntax
          </div>
        );
        break;
      case "time":
              ...
              <div className='row'>
                ...
                <div className='col2'>
                  <input
                    ...
                    onChange={this.handleInputChange}
                    onFocus={this.handleFocus}
                    className={`shorter30 ${this.state.errors.includes("siteid") ? "inputerror" : ""}`}
                  />
                  .
                  <select
                    name='project'
              ...
              <div className='row'>
                ...
                <div className='col2'>
                  <input
                    ...
                    onChange={this.handleInputChange}
                    onFocus={this.handleFocus}
                    className={this.state.errors.includes("property") ? "inputerror" : ""}
                  />
              ...
              <div className='row'>
                ...
                <div className='col2'>
                  <input
                    ...
                    onChange={this.handleInputChange}
                    onFocus={this.handleFocus}
                    className={this.state.errors.includes("template") ? "inputerror" : ""}
                  />
              ...
              <div className='row'>
                <div className='col2'>
                  <input
                    ...
                    onChange={this.handleInputChange}
                    onFocus={this.handleFocus}
                    className={this.state.errors.includes("alreadyset") ? "inputerror" : ""}
                  />{" "}
                  do not load items with property set
                </div>
              </div>
            </div>
